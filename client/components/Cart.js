...
//C: unit price for products in not showing in cart
//C: when product gets to zero in qty the product is removed from the cart but still shows in the cart. so if you try and increment at that point an error is thrown
